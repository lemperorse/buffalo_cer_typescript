...
<div class="flex flex-wrap">
    <div class="w-full">
        <ul class="flex mb-0 list-none pt-3 pb-4 flex-col md:flex-row animate__animated animate__bounceInUp animate__delay-1s">
            ...
            <li class="-mb-px mr-2 last:mr-0 flex-auto text-center border rounded cursor-pointer">
                <a class="w-full hvr-grow text-base font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal" v-on:click="toggleTabs(5)" v-bind:class="{'text-blue-600 bg-white': openTab !== 5, 'text-white bg-blue-600': openTab === 5}">
