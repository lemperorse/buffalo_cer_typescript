      ...
      <div class="px-6">
        <div class="flex flex-wrap justify-center">
          <div class="w-full px-4 flex justify-center">
            <div class="relative">
              <img style="width:150px; height:150px;" ref="frontImage"
                   src="https://sv1.picz.in.th/images/2020/11/07/bjhzBy.png"
                   class="shadow-xl rounded-full  h-auto align-middle border-none -mt-16 w-48 h-48" alt="" srcset="">
              <div class="flex flex-col justify-center  mt-4">
                <center><h2 class="text-xl font-bold">ภายถ่ายด้านหน้า</h2></center> <br>
                <input type="file" ref="front" @change="frontChange" style="display:none;" />
                <button @click="$refs.front.click()"
    ...
    >
      <div class="px-6 ">
        <div class="flex flex-wrap justify-center">
          <div class="w-full px-4 flex justify-center">
            <div class="relative">
              <img ref="backImage" style="width:150px; height:150px;"
                  src="https://sv1.picz.in.th/images/2020/11/07/bjhzBy.png"
                  class="shadow-xl rounded-full  h-auto align-middle border-none -mt-16 w-48 h-48" alt="" srcset="">
              <div class="flex flex-col justify-center  mt-4">
                <center><h2 class="text-xl font-bold">ภายถ่ายด้านข้าง</h2></center> <br>
                <input type="file" ref="back" @change="backChange" style="display:none;" />
                <button @click="$refs.back.click()"
                        class="bg-green-500 f-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button">
                  อัพโหลดรูปภาพ
                </button> <br>
