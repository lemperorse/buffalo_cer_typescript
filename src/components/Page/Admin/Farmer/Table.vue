    ...
    <div class="rounded-t mb-0 px-4 py-3 border-0">
        ...
        <!-- <div class="flex flex-wrap ">
            <form @submit.prevent="run"> 
                <div class="flex w-auto rounded border bg-gray-100 hover:shadow-lg">
                    <button>
                        <span class="w-auto flex justify-end items-center text-grey p-2 w-full">
            ...
            <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                <button @click="$router.push('/admin/addfarmer')" class="f-white md:w-2/12 w-full rounded p-2 bg-indigo-500 hover:bg-indigo-800 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-indigo-600 focus:ring-opacity-50 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" type="button">
