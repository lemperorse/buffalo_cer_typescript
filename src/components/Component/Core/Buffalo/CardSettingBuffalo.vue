...
<div class="flex flex-wrap">
    <div class="w-full">
        <ul class="flex flex-col mb-0 list-none flex-wrap pt-3 pb-4 md:flex-row animate__animated animate__bounceInUp animate__delay-1s">
            ...
            <li class="-mb-px last:mr-0 flex-auto text-center rounded-lg cursor-pointer md:m-2 pb-1">
                <a class="w-full text-base font-bold uppercase px-5 py-3 shadow-lg rounded-lg block leading-normal row wrap" v-on:click="toggleTabs(4)" v-bind:class="{'text-blue-600 bg-white': openTab !== 4, 'text-white bg1': openTab === 4}">
