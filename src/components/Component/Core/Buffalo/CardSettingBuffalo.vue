...
<div class="flex flex-wrap">
    <div class="w-full">
        <v-card class="my-4" elevation="2" v-if="$vuetify.breakpoint.mobile">
            <v-tabs flat show-arrows>
                <v-tabs-slider color="amber accent-3"></v-tabs-slider>
                <v-tab @click="toggleTabs(1)" class="m-2" rounded elevation="3" :color="openTab == 1 ? `green` : ``">
                    <img src="assets/buffalo/buffalo.png" height="24px" width="24px" class="rounded-lg" alt="" />
                    <span class="text-black pl-2">ข้อมูลควาย</span>
                </v-tab>
                <v-tab @click="toggleTabs(2)" class="m-2" rounded elevation="3" :color="openTab == 2 ? `green` : ``">
                ...
                <v-tab @click="toggleTabs(3)" class="m-2" rounded elevation="3" :color="openTab == 3 ? `green` : ``">
                ...
                <v-tab @click="toggleTabs(4)" class="m-2" rounded elevation="3" :color="openTab == 4 ? `green` : ``">
          ...
          ">
            ...
            ">
              ...
              " v-on:click="toggleTabs(1)" v-bind:class="{
                ...
                'text-white  bg-yellow-500': openTab === 1,
              }">
                        <img src="assets/buffalo/buffalo.png" height="24px" width="24px" class="rounded-lg" alt="" />
                        <span class="text-black pl-2">ข้อมูลควาย</span>
                    </a>
            ...
            ">
              ...
              " v-on:click="toggleTabs(2)" v-bind:class="{
                ...
                'text-white  bg-yellow-500': openTab === 2,
              }">
                        <img src="assets/farm/2826134-agriculture/png/065-plant.png" height="24px" width="24px" class="rounded-lg" alt="" />
                        <span class="text-black pl-2">การเจริญเติบโต</span>
                    </a>
            ...
            ">
              ...
              " v-on:click="toggleTabs(3)" v-bind:class="{
                ...
                'text-white  bg-yellow-500': openTab === 3,
              }">
                        <img src="assets/farm/2826134-agriculture/png/076-award.png" height="24px" width="24px" class="rounded-lg" alt="" />
                        <span class="text-black pl-2">ใบพันธุ์ประวัติ</span>
                    </a>
            ...
            ">
              ...
              " v-on:click="toggleTabs(4)" v-bind:class="{
                ...
                'text-white  bg-yellow-500': openTab === 4,
              }">
                        <img src="assets/farm/2826134-agriculture/png/068-phone.png" height="24px" width="24px" class="rounded-lg" alt="" />
                        <span class="text-black pl-2">ตั้งค่า</span>
                    </a>
