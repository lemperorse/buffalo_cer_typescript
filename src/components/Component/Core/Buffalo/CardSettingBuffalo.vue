    ...
    <div class="w-full">
      <v-card class="my-4" elevation="2" v-if="$vuetify.breakpoint.mobile">
        <v-tabs flat show-arrows>
          ...
          >
            <img
              src="assets/buffalo/buffalo.png"
              height="24px"
              width="24px"
              class="rounded-lg"
              alt=""
          ...
          >
            <img
              src="assets/farm/2826134-agriculture/png/065-plant.png"
              height="24px"
              width="24px"
              class="rounded-lg"
              alt=""
          ...
          >
            <img
              src="assets/farm/2826134-agriculture/png/076-award.png"
              height="24px"
              width="24px"
              class="rounded-lg"
              alt=""
