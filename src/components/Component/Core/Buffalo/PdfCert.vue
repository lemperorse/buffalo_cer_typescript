  ...
  methods: {
    async load() {
      ...
      this.dataBuffalo = await Core.getHttp(
        `/report/cert/${this.$route.query.id}/`
      );
    ...
    async exporPDF() {
      ...
      const docDefinition = {
        ...
        watermark: {
          text: "สำนักงานปศุสัตว์ จังหวัดพะเยา",
          color: "blue",
          opacity: 0.1,
          bold: true,
          italics: false,
            ...
            table: {
              ...
              body: [
                [
                  ...
                  { text: " ", border: [false, false, false, false] },
                  {
                    text: "ปู่\n" + this.dataBuffalo.grand_father_male,
                ...
                [
                  ...
                  { text: " ", border: [false, false, false, false] },
                  {
                    text: "ย่า\n" + this.dataBuffalo.grand_mother_male,
                    border: [false, false, false, true],
                  },
                ],
                [
                ...
                [
                  ...
                  { text: " ", border: [false, false, false, false] },
                  {
                    text: "ตา\n" + this.dataBuffalo.grand_father_female,
                    border: [false, false, false, true],
                  },
                ],
                [
                ...
                [
                  ...
                  { text: " ", border: [false, false, false, false] },
                  {
                    text: "ยาย\n" + this.dataBuffalo.grand_mother_female,
                    border: [false, false, false, true],
                  },
                ],
              ],
        ...
        //       { type: "line", x1: 0, y1: -65, x2: 725, y2: -65, lineWidth: 1 }, //Up line
        //       { type: "line", x1: 0, y1: 435, x2: 725, y2: 435, lineWidth: 1 }, //Bottom line
        //       { type: "line", x1: 0, y1: -65, x2: 0, y2: 435, lineWidth: 1 }, //Left line
        //       { type: "line", x1: 725, y1: 435, x2: 725, y2: -65, ineWidth: 1 }, //Rigth line
        //     ],
        //   },
        // ],
        images: {
