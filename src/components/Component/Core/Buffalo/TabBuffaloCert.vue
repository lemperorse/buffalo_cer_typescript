...
<div>
              ...
              <div class="
                ...
                <div class="w-full px-1">
                  <div class="relative w-full mb-3">
                    ...
                    <div class="flex">
                      <v-text-field v-model="form.grand_father_male_nid" filled rounded type="text" name="name" label="ปู่" id="id"></v-text-field>
                      <v-btn @click="dialogFatherMale = true" class="success ml-2" dark depressed fab>
                        <v-icon>fas fa-search</v-icon>
                      </v-btn>
                    </div>
                  </div>
                ...
                <div class="w-full px-1">
                  <div class="relative w-full mb-3">
                    ...
                    <div class="flex">
                      <v-text-field v-model="form.grand_mother_male_nid" filled rounded type="text" name="name" label="ย่า" id="id"></v-text-field>
                      <v-btn @click="dialogMotherMale = true" class="success ml-2" dark depressed fab>
                        <v-icon>fas fa-search</v-icon>
                      </v-btn>
                    </div>
                  </div>
              ...
              <div class="
                ...
                <div class="w-full px-1">
                  <div class="relative w-full mb-3">
                    ...
                    <div class="flex">
                      <v-text-field v-model="form.grand_father_female_nid" filled rounded type="text" name="name" label="ตา" id="id"></v-text-field>
                      <v-btn @click="dialogFatherFemale = true" class="success ml-2" dark depressed fab>
                        <v-icon>fas fa-search</v-icon>
                      </v-btn>
                    </div>
                  </div>
                ...
                <div class="w-full px-1">
                  <div class="relative w-full mb-3">
                    ...
                    <div class="flex">
                      <v-text-field v-model="form.grand_mother_female_nid" filled rounded type="text" name="name" label="ยาย" id="id"></v-text-field>
                      <v-btn @click="dialogMotherFemale = true" class="success ml-2" dark depressed fab>
                        <v-icon>fas fa-search</v-icon>
                      </v-btn>
                    </div>
                  </div>
  ...
  <div>
      ...
      <v-card>
        <v-card-title primary-title>
          ...
          <v-btn color="error" @click="
                chooseFather = null;
                dialogFather = false;
              " class="bg-blue-600 ml-2" icon rounded>
    ...
    <!-- ปู่ย่า -->
    <v-dialog v-model="dialogFatherMale" persistent max-width="500px" style="z-index: 1003">
      <v-card>
        <v-card-title primary-title>
          เลือกพ่อพันธ์ุ
          <v-spacer></v-spacer>
        ...
        <v-card-text>
          <v-autocomplete filled rounded v-model="chooseFatherMale" return-object item-text="name" :items="buffalos"></v-autocomplete>
          <v-btn @click="chooseFatherData()" color="purple" dark large rounded block>เลือก</v-btn>
          <!-- <button @click="chooseFatherData()" :class="`bg-blue-600 ${$btn}`">เลือก</button> -->
        </v-card-text>
      </v-card>
    </v-dialog>
    <v-dialog v-model="dialogMotherMale" persistent max-width="500px" style="z-index: 1003">
      <v-card>
        <v-card-title primary-title>
          เลือกย่า
          <v-spacer></v-spacer>
        ...
        <v-card-text>
          <v-autocomplete filled rounded v-model="chooseMotherMale" return-object item-text="name" :items="buffalos"></v-autocomplete>
          <v-btn @click="chooseMotherData()" color="purple" dark large rounded block>เลือก</v-btn>
          <!-- <button @click="chooseMotherData()" :class="`bg-blue-600 ${$btn}`">เลือก</button> -->
        </v-card-text>
      </v-card>
    ...
    <!-- ตายาย -->
    <v-dialog v-model="dialogFatherFemale" persistent max-width="500px" style="z-index: 1003">
      <v-card>
        <v-card-title primary-title>
          เลือกพ่อพันธ์ุ
          <v-spacer></v-spacer>
        ...
        <v-card-text>
          <v-autocomplete filled rounded v-model="chooseFatherFemale" return-object item-text="name" :items="buffalos"></v-autocomplete>
          <v-btn @click="chooseFatherData()" color="purple" dark large rounded block>เลือก</v-btn>
          <!-- <button @click="chooseFatherData()" :class="`bg-blue-600 ${$btn}`">เลือก</button> -->
        </v-card-text>
      </v-card>
    </v-dialog>
    <v-dialog v-model="dialogMotherFemale" persistent max-width="500px" style="z-index: 1003">
      <v-card>
        <v-card-title primary-title>
          เลือกยาย
          <v-spacer></v-spacer>
        ...
        <v-card-text>
          <v-autocomplete filled rounded v-model="chooseMotherFemale" return-object item-text="name" :items="buffalos"></v-autocomplete>
          <v-btn @click="chooseMotherData()" color="purple" dark large rounded block>เลือก</v-btn>
          <!-- <button @click="chooseMotherData()" :class="`bg-blue-600 ${$btn}`">เลือก</button> -->
        </v-card-text>
      </v-card>
