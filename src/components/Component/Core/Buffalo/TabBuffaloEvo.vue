...
<div>
    ...
    <div>
        <div id="chart" style="overflow-x: scroll">
            <apexchart type="line" height="250" :options="graghKK.chartOptions" :series="graghKK.series"></apexchart>
            <!-- <apexchart type="bar" height="250" :options="graghCM.chartOptions" :series="graghCM.series"></apexchart> -->
    ...
    <div class="flex-auto px-1 lg:px-10 py-10 pt-0">
        <form @submit.prevent="updateBuffalo">
            <v-alert color="#F59E0B" type="info" outlined v-if="!unEdit">
                ...
                <v-btn class="border-edit" x-small style="background-color: #eeeef3; color: #f59e0b">ข้อความ</v-btn>
            </v-alert>
