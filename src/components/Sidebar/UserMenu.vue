...
<nav class="mt-10">
    <hr class="p-2">
    <button class="flex text-left mt-4 py-2 px-6 w-full hvr-grow " :class="($route.path == route.path)?'bg-blue-500 ':''" v-for="route,index in routes" :key="index" v-if="route.show" @click="changeRoute(route.path)">
