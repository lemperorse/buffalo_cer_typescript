...
<!--          </li>-->
          ...
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-gray-300 text-gray-500 fab fa-app-store-ios text-lg leading-lg"
              />
          ...
          <li class="flex items-center">
            ...
            >
              <i
                class="lg:text-gray-300 text-gray-500 fab fa-google-play text-lg leading-lg"
              />
          ...
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-arrow-alt-circle-down"></i> ดาวน์โหลด
            </button>
          </li>
        </ul>
      </div>
