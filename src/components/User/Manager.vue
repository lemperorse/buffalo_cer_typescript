                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            ...
                            <input placeholder="ระบุรหัสผ่าน ***" v-model="formPassword.password" required type="password" class="border-edit px-3 py-3 pl-10 placeholder-gray-400 bg-gray-100 text-black rounded text-sm shadow focus:outline-none focus:shadow-outline w-full ease-linear transition-all duration-150 focus:ring-1 focus:ring-yellow-600 focus:border-yellow-600`" value="" />
                        </div>
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            ...
                            <input placeholder="ระบุรหัสผ่าน ***" v-model="formPassword.password2" required type="password" class="border-edit px-3 py-3 pl-10 placeholder-gray-400 bg-gray-100 text-black rounded text-sm shadow focus:outline-none focus:shadow-outline w-full ease-linear transition-all duration-150 focus:ring-1 focus:ring-yellow-600 focus:border-yellow-600`" value="" />
                        </div>
                    </div>
                    <div class="relative w-full mb-3">
                        <button type="submit" class="f-white w-full rounded p-2 bg-yellow-500 hover:bg-yellow-800 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-yellow-600 focus:ring-opacity-50 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">อัพเดทรหัสผ่าน</button>
                    </div>
