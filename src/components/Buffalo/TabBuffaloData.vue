                ...
                <div class="w-full lg:w-6/12 px-4 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" required v-model="form.name" type="text" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" v-model="form.price" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" v-model="form.nid" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" v-model="form.microship" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" required v-model="form.birthday" type="date" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input :disabled="unEdit" v-model="form.age" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select :disabled="unEdit" v-model="form.gender" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select :disabled="unEdit" v-model="form.color" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select :disabled="unEdit" v-model="form.status" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select :disabled="unEdit" v-model="form.froms" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
