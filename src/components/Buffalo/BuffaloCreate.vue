    ...
    <div class="rounded-t bg-white mb-0 px-6 py-6  ">
        <div class="text-center flex justify-between ">
            <h6 class="text-gray-800 text-xl font-bold">
                ...
                <button class="text-purole-600  ">สร้างควาย</button>
            </h6>
        </div>
    </div>
                ...
                <div class="w-full lg:w-6/12 px-4 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input required v-model="form.name" type="text" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input v-model="form.price" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input v-model="form.nid" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input v-model="form.microship" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input required v-model="form.birthday" type="date" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative flex w-full flex-wrap items-stretch mb-3">
                            ...
                            <input v-model="form.age" type="number" :class="$xinput" value=" " class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10"/>
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select v-model="form.gender" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select v-model="form.color" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select v-model="form.status" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <div class="relative">
                            ...
                            <select v-model="form.froms" required :class="$xinput" class="px-2 py-1 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pl-10">
            ...
            <div class="flex flex-wrap flex justify-center">
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        ...
                        <input required style="width:60px;" type="file" @change="backChange">
                    </div>
                </div>
            </div>
