                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full px-1">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <div class="flex">
                                            <input v-model="form.father_nid" type="text" :class="`${$xinput} border-edit focus:ring-1 focus:ring-yellow-600 focus:border-yellow-600`" value="Lucky" />
                                            <v-btn @click="dialogFather = true" class="bg-blue-600 ml-2 mt-1" style="background-color: blue;" dark icon rounded>
                                ...
                                <div class="w-full   px-1">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <div class="flex">
                                            <input v-model="form.mother_nid" type="text" :class="`${$xinput} border-edit focus:ring-1 focus:ring-yellow-600 focus:border-yellow-600`" value="Lucky" />
                                            <v-btn @click="dialogMother = true" class="bg-blue-600 ml-2 mt-1" style="background-color: blue;" dark icon rounded>
                                                <v-icon>fas fa-search</v-icon>
                                            </v-btn>
                                        </div>
                                ...
                                <div class="w-full px-1">
                                    <div class="relative w-full mb-3">
                                        <button type="submit" :class="`f-white ${$btnsuccess1}`"><i class="fas fa-save text-lg"></i>
                                            บันทึก
                                        </button>
                                    </div>
