            ...
            <div class="rounded-t mb-0 px-6 py-6">
              ...
              <div class="text-blue-500 text-center mb-3 font-bold">
                ...
                <div class="w-full md:w-12/12 pt-2">
                  <v-text-field type="text" required :rules="[v => !!v || 'ต้องระบุ']" label="ชื่อผู้ใช้งาน" solo ></v-text-field>
                </div>
                <div class="w-full md:w-12/12 pt-2">
                  <v-text-field type="password" required :rules="[v => !!v || 'ต้องระบุ']" label="รหัสผ่านเก่า" solo ></v-text-field>
                </div>
                <div class="w-full md:w-12/12 pt-2">
                  <v-text-field type="password" required :rules="[v => !!v || 'ต้องระบุ']" label="รหัสผ่านใหม่" solo ></v-text-field>
                </div>
                <div class="w-full md:w-12/12 pt-2">
                  <v-text-field type="password" required :rules="[v => !!v || 'ต้องระบุ']" label="ยืนยันรหัสผ่าน" solo ></v-text-field>
                </div>
